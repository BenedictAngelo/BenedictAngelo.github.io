const experiences = [
  {
    ...
    description:
      "Leading visa application center worldwide, currently a trainee officer in-charge of customer visa inquiries for France",
  ...
  },
  {
    ...
    technologies: ["Micro-controllers", "Micro-pc", "Embedded C", "Python", "Bare Metal"],
    current: false,
  },
];
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="max-w-3xl mb-16">
          ...
          >
            ...
            a never ending strive for knowledge and experience.
          </p>
        </div>
        ...
        <div className="relative">
          <div 
            className="timeline-glow absolute left-0 md:left-1/2 top-0
            bottom-0 w-[2px] bg-gradient-to-b from-primary/70
            via-primary/30 to-transparent md:-translate-x-1/2
            shadow-[0_020px_rgba(32,178,166,0.8)]"
          />
