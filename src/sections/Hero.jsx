...
export const Hero = () =>{
  return (
    <section 
      className="relative min-h-screen flex item-center overflow-hidden"
    >
      {/* Bg */}
      <div className="absolute inset-0">
        ...
        />
        <div className="absolute inset-0 bg0-gradient-to-b from-background/20 via-background/80 to-background"></div>
      </div>
      {/* Green dots */}
          ...
          <div className="space-y-8">
            <div className="animate-fade-in">
              <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass text-sm text-primary">
                ...
                Electronics Engineer • Network and Cybersecurity Specialist
              </span>
            </div>
            ...
            <div className="space-y-4">
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight animate-fade-in animation-delay-100">
                <span className="underline text-3xl md:text-4xl lg:text-5xl">
                ...
                <span className="font-serif italic font-normal text-white">
                  <span className="text-primary glow-text">SECURITY</span> in mind.
                </span>
              </h1>
              <p 
              ...
              >
                ...
                and full-stack applications using
                <span className="font-bold"> React, Tauri, Axum, and PostgreSQL</span>.
            ...
            <div className="flex items-center gap-4 animate-fade-in animation-delay-400">
              ...
              {[
                {icon: Github,href:"https://github.com/BenedictAngelo"},
                {icon: Linkedin,href:"https://www.linkedin.com/in/benedictangelo/"},
                {icon: Facebook,href:"https://www.facebook.com/profile.php?id=61583860295569"}
              ].map((social, idx) =>(
                <a 
                    key={idx} 
                    href={social.href} 
            ...
            <div className="relative max-w-md mx-auto">
              ...
              <div className="relative glass rounded-3xl p-2 glow-border">
                <img 
                  ...
                  alt="Benedict Angelo" 
                  className="w-full aspect-[4/5] obect-cover rounded-2xl"
                />
